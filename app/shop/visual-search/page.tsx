                    ...
                    <CardContent className="space-y-4">
                        <div className="flex items-center justify-center w-full">
                            <label className="flex flex-col items-center justify-center w-full h-48 border-2 border-dashed rounded-lg cursor-pointer hover:bg-muted/50 transition-colors relative">
                                {previewUrl ? (
                                    <Image src={previewUrl} alt="Preview" className="h-full object-contain p-2" fill unoptimized sizes="100vw" />
                                ) : (
                                ...
                                <Card key={product.id} className="overflow-hidden hover:shadow-lg transition-shadow">
                                    <div className="aspect-square relative bg-muted">
                                        <Image
                                            ...
                                            sizes="100vw"
                                            onError={(e) => {
                                                (e.currentTarget as HTMLImageElement).srcset = 'https://placehold.co/400x400?text=No+Image';
                                            }}
                                        />
